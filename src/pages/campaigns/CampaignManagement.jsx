  ...
  const campaignSteps = [
    {
      ...
      content: "Hi [[first_name]], I hope this message finds you well! My name is [[sender_first_name]] [[sender_last_name]], and I'm reaching out from [[sender_company]] because I believe we can help [[company]] tackle a...",
      active: true,
      replyInThread: false,
      noSubject: false
    },
          ...
          {campaignSteps.map((step) => (
            <div key={step.id} className="grid grid-cols-12 gap-4 p-4 hover:bg-gray-50">
              ...
              <div className="col-span-6">
                <div className="space-y-2">
                  <div className="text-sm font-medium text-gray-900">
                    {step.subject}
                    {step.replyInThread && (
                      <span className="ml-2 text-xs text-gray-500">Reply in Thread - No Subject</span>
                    )}
                  </div>
                  {step.content && (
              ...
              <div className="col-span-1 flex items-center">
                <div className={`w-10 h-6 rounded-full p-1 ${step.active ? 'bg-green-500' : 'bg-gray-300'} transition-colors cursor-pointer`}>
                  <div className={`w-4 h-4 rounded-full bg-white transform transition-transform ${step.active ? 'translate-x-4' : ''}`}></div>
                </div>
              </div>
